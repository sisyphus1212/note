...
./build/app/dpdk-testpmd -a 0000:0d:00.0 -m 2G  -l 0-2 -n 4 -- --eth-link-speed 25G --eth-peer=0,04:3f:72:e4:88:5b  --tx-ip=1.1.1.1,2.2.2.15   --forward-mode=txonly --txpkts=1500 --burst=64 --txq=4 --txd=1024 --flowgen-flows=8  --nb-cores=2 --txonly-multi-flow --display-xstats tx-test --stats-period 1 --record-core-cycles --record-burst-stats
