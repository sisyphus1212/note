...
./build/app/dpdk-testpmd -a 0000:0d:00.0 -m 2G  -l 0-3 -n 4 -- \
                --forward-mode=txonly --nb-cores=2 --txonly-multi-flow \
                --eth-link-speed 25G --txpkts=1500 --burst=64 --txq=4 --txd=1024 \
                --eth-peer=0,04:3f:72:e4:88:5b --tx-ip=1.1.1.1,2.2.2.15 \
